    ...
    <Layout>
      <FilmedGameScheduleStyles>
        <div className="wrapper">
          ...
          <p>
            This game will be added to the filmed games database. The game will
            be available to select when entering a campers filmed games portion
          ...
          <Formik
            ...
            onSubmit={async values => {
              const response = await fetch('/api/add-game-to-film-schedule', {
                method: 'post',
              ...
              if (result.success) {
                ...
                // and clear the form so user can add another game
